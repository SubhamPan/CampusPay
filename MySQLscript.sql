...
delimiter / / create procedure get_total_amount_spent_by_student (
    IN student_id varchar(50),
    OUT total_amount_spent int
) begin
select
    sum(total_amount) into total_amount_spent
from
    transactions
where
...
delimiter / / create procedure get_total_amount_earned_by_vendor (
    IN vendor_id varchar(50),
    OUT total_amount_earned int
) begin
select
    sum(total_amount) into total_amount_earned
from
    transactions
where
...
delimiter / / create procedure get_all_transactions_made_by_vendor (IN vendor_id varchar(50)) begin
...
delimiter / / create procedure get_all_items_sold_by_vendor (IN vendor_id varchar(50)) begin
select
    *
from
    items
...
delimiter / / create procedure add_item_to_menu (
    IN item_name varchar(50),
    IN price int,
    IN vendor_id varchar(50)
) begin
insert into
    items (item_name, price, vendor_id)
values
    (item_name, price, vendor_id);

end / / delimiter;

-- procedure to a new order
delimiter / / create procedure make_order (
...
insert into
    orders (transaction_id, item_id, price, quantity)
values
...
delimiter / / create procedure make_transaction (
    IN vendor_id varchar(50),
    IN student_id varchar(50),
    IN total_amount int,
    OUT status int
...
insert into
    transactions (vendor_id, student_id, total_amount, date_time)
values
    (vendor_id, student_id, total_amount, now ());
...
delimiter / / create procedure update_student_details (
    IN ID varchar(50),
...
delimiter / / create procedure update_vendor_details (
    IN ID varchar(50),
...
delimiter / / create procedure update_item_details (IN ID int, IN item_name varchar(50), IN price int) begin
update items
set
    item_name = item_name,
    price = price
...
delimiter / / create procedure get_all_payments_made_by_student (IN student_id varchar(50)) begin
select
    transactions.id,
    vendors.v_name,
    transactions.total_amount,
...
delimiter / / create procedure get_all_students () begin
select
    *
from
    student;
...
delimiter / / create procedure get_all_vendors () begin
select
    *
from
    vendors;
...
delimiter / / create procedure get_all_transactions () begin
select
    *
from
    transactions;
...
delimiter / / create procedure get_all_orders_of_transaction (IN transaction_id int) begin
...
delimiter / / create procedure get_student_details (IN ID varchar(50)) begin
select
    *
from
    student
...
delimiter / / create procedure get_vendor_details (IN ID varchar(50)) begin
select
    *
from
    vendors
...
delimiter / / create procedure get_item_details (IN ID int) begin
select
    *
from
    items
...
delimiter / / create procedure verify_login (
    IN ID varchar(50),
    IN password varchar(256),
    IN role int
) begin
...
delimiter / / create procedure register_vendor (
    IN ID varchar(50),
    IN v_name varchar(50),
    IN account_no varchar(50),
    IN contact char(10),
...
insert into
    vendors (ID, v_name, account_no, contact)
values
    (ID, v_name, account_no, contact);
...
insert into
    student (ID, account_no, s_name, contact)
values
    (ID, account_no, s_name, contact);
...
delimiter / / create procedure register_admin (IN ID varchar(50), IN password varchar(256)) begin
insert into
    login (ID, password, role)
values
    (ID, password, 2);
...
delimiter / / create procedure delete_item (IN ID int) begin
...
delimiter / / create procedure delete_transaction (IN ID int) begin
...
delimiter / / create procedure get_most_popular_item_of_vendor (
    IN vendor_id varchar(50),
    OUT ID int,
    OUT item_name varchar(50)
) begin
select
    items.ID,
    items.item_name into ID,
    item_name
from
    items,
    orders
...
delimiter / / create procedure get_most_bought_item_by_student (
    IN student_id varchar(50),
    OUT ID int,
    OUT item_name varchar(50),
...
delimiter / / create procedure update_transaction (
    IN vendor_id varchar(50),
    IN student_id varchar(50),
    IN total_amount int,
...
delimiter / / create procedure set_monthly_budget (IN ID varchar(50), IN budget int) begin
update student
set
    budget = budget
where
...
delimiter / / create procedure get_monthly_budget (IN ID varchar(50), OUT monthly_budget int) begin
-- select budget into budget from student where student.ID = ID;
select
    budget into monthly_budget
from
    student
where
        student.ID = ID;
...
delimiter / / create procedure get_total_amount_spent_by_student_last_month (
    IN student_id varchar(50),
    OUT total_amount_spent int
) begin
select
...
delimiter / / create procedure get_budget_left (IN ID varchar(50), OUT budget_left int) begin
